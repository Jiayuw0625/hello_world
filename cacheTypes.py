...
class SchedulerProtocol(Protocol):
    ...
    def schedule(self, duration_in_seconds: float, fn: Callable[[], None]) -> Callable[[], None]:
        """
        Schedules work to be executed after a set duration.
        Returns a cancellation function that can be called to cancel
        the scheduled work before the duration has elapsed.
        """
